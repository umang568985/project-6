...
class GameCenterApp(App):
    def build(self):
        return GameCenterScreenManager()

class GameCenterScreenManager(ScreenManager):
    pass
...
class MainMenuScreen(Screen):
    def on_enter(self):
        ...
        title_label = Label(text="Welcome to the Game Center!", font_size=30)
        snake_button = Button(text="1. Snake")
        tic_tac_toe_button = Button(text="2. Tic Tac Toe")
        pong_button = Button(text="3. Pong")
        quit_button = Button(text="4. Quit")

        snake_button.bind(on_release=self.load_snake)
        tic_tac_toe_button.bind(on_release=self.load_tic_tac_toe)
        pong_button.bind(on_release=self.load_pong)
        quit_button.bind(on_release=self.quit_app)

        self.add_widget(title_label)
        self.add_widget(snake_button)
        self.add_widget(tic_tac_toe_button)
        self.add_widget(pong_button)
        self.add_widget(quit_button)

    def load_snake(self, instance):
        self.manager.transition.direction = 'left'
        self.manager.current = 'snake_screen'

    def load_tic_tac_toe(self, instance):
        self.manager.transition.direction = 'left'
        self.manager.current = 'tic_tac_toe_screen'

    def load_pong(self, instance):
        self.manager.transition.direction = 'left'
        self.manager.current = 'pong_screen'
